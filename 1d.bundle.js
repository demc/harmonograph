...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Pendulum1D = __webpack_require__(1);

	var _Pendulum1D2 = _interopRequireDefault(_Pendulum1D);

	var _PendulumDial = __webpack_require__(3);

	var _PendulumDial2 = _interopRequireDefault(_PendulumDial);

	var _Formula1D = __webpack_require__(4);

	var _Formula1D2 = _interopRequireDefault(_Formula1D);

	var _FullScreenScene = __webpack_require__(30);

	var _FullScreenScene2 = _interopRequireDefault(_FullScreenScene);

	var _SineWave = __webpack_require__(33);
	...
	var formulaValues = document.getElementById('formula-values');

	setupCanvas(content, canvas, formula, formulaValues);

	function setupCanvas(content, canvas, formula, formulaValues) {
	  var _getVisualizationStat = getVisualizationState(content, canvas, formula, formulaValues),
	      ctx = _getVisualizationStat.ctx,
	      scene = _getVisualizationStat.scene,
	      pendulumDial = _getVisualizationStat.pendulumDial,
	      pendulum1D = _getVisualizationStat.pendulum1D,
	      unitCircle = _getVisualizationStat.unitCircle,
	      sineWave = _getVisualizationStat.sineWave,
	      formula1D = _getVisualizationStat.formula1D;
	...
	function getVisualizationState(content, canvas, formulaNode, formulaValuesNode) {
	  if (canvas._state) {
	    ...
	    var formula1D = new _Formula1D2.default(formulaNode, formulaValuesNode, 'x', 100, Math.PI, Math.PI / 2);
	    formula1D.render();

	    var state = {
	      ctx: ctx,
	      scene: scene,
	      pendulumDial: pendulumDial,
	      pendulum1D: pendulum1D,
	...
	function setupInputHandlers(ctx, scene, pendulumDial, pendulum1D, unitCircle, sineWave, formula1D) {
	  ...
	  var phaseShiftInput = document.getElementById('phase-shift');
	  var amplitudeInput = document.getElementById('amplitude');
	  var dampingInput = document.getElementById('damping');

	  frequencyInput.addEventListener('input', debounce(createInputHandler(frequencyInput, [pendulumDial, unitCircle, pendulum1D, sineWave, formula1D], 'setFrequency', Math.PI), 100));

	  phaseShiftInput.addEventListener('input', debounce(createInputHandler(phaseShiftInput, [pendulumDial, unitCircle, pendulum1D, sineWave, formula1D], 'setPhaseShift', Math.PI), 100));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Pendulum1D = function () {
	  function Pendulum1D(scene, x, y, width, height, amplitude, frequency) {
	    _classCallCheck(this, Pendulum1D);
	    ...
	    this.phaseShift = _constants.HALF_PI; // Must be in radians
	    this.dampingRatio = 0;
	    ...
	    this._prevPendulumX = this._pendulumX = this._pendulumXOrigin + this._pendulumDelta.dx;
	    this._prevPendulumY = this._pendulumY = this._pendulumYOrigin + this._pendulumDelta.dy;
	  ...
	  _createClass(Pendulum1D, [{
	    ...
	    key: 'drawHalfCircle',
	    value: function drawHalfCircle() {
	      this.ctx.save();
	      this.ctx.setLineDash([4, 2]);
	      this.ctx.strokeStyle = '#CCC';
	      this.ctx.beginPath();
	      this.ctx.arc(this._pendulumXOrigin, this._pendulumYOrigin, this.amplitude, Math.PI, _constants.TWO_PI, true);
	      this.ctx.stroke();
	      this.ctx.restore();
	    }
	  }, {
	    ...
	    value: function _delta(t) {
	      var dx = this.amplitude * Math.sin(this.frequency * t + this.phaseShift);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Formula1D = function () {
		function Formula1D(formulaNode, formulaValuesNode, variable, amplitude, frequency, phaseShift) {
			_classCallCheck(this, Formula1D);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SineWave = function () {
	  function SineWave(scene, x, y, width, height, amplitude, frequency) {
	    ...
	    this.phaseShift = _constants.HALF_PI;
	    this.dampingRatio = 0;
	  ...
	  _createClass(SineWave, [{
	    ...
	    value: function drawWave() {
	      ...
	      for (var i = 0; i < this._steps.length; i++) {
	        var y = this._steps[this._steps.length - i - 1];
	        var x = this.frequency * i * _constants.TICK_IN_SEC * this.amplitude / Math.PI;
	    ...
	    key: '_computeStepY',
	    value: function _computeStepY() {
	      var dy = this.amplitude * Math.sin(this.frequency * this.t + this.phaseShift);
